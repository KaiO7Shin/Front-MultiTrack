...
export function EligibleIcon() {
  return (
    <svg className="eligibility-icon eligibility-yes" viewBox="0 0 24 24" aria-hidden="true">
...
export function IneligibleIcon() {
  return (
    <svg className="eligibility-icon eligibility-no" viewBox="0 0 24 24" aria-hidden="true">
      <circle cx="12" cy="12" r="9" />
